  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center pt-20">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald/30 bg-emerald/10 text-emerald mb-8 opacity-0 animate-fade-up text-sm font-medium">
          <span className="h-2 w-2 rounded-full bg-emerald animate-pulse-glow" />
          Live Carbon Monitoring Active
        </div>
